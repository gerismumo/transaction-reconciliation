...
function  PrivateVC() {
  ...
  const filteredTransactions = transactions.filter(
    (transaction) =>
      transaction.branch === user.branch && transaction.coverage_type === 'PrivateVehicle/Comprehensive'
  );
    return(
        <>
        ...
        <table>
            ...
            {filteredTransactions.map((transaction) => (
              ...
              <p>No Private Vehicle Comprehensive insurance transactions yet</p>
          )}
